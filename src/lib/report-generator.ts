...
function appendFooter(lines: string[]): void {
  ...
  lines.push("")
  lines.push(
    "*This report was generated by [airtable-migration-audit](https://github.com/mperlak/airtable-migration-audit) — a free, open-source Airtable migration analysis tool. Built by the creator of [Straktur](https://straktur.com), a Next.js boilerplate for internal business apps.*"
  )
  lines.push("")
}
